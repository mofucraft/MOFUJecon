...
class VaultEconomy implements Economy {
    ...
    public int fractionalDigits() {
        /* Hint: How does Mecon keep decimals?
            Mecon multiplies the value up to two decimal places by 100 times and treats it.
    ...
    private static EconomyResponse notImplementedBank() {
        return new EconomyResponse(0, 0, EconomyResponse.ResponseType.NOT_IMPLEMENTED, "Mecon does not support bank.");
    }
    // endregion
}
