package jp.jyn.mecon.config;

import jp.jyn.jbukkitlib.config.YamlLoader;
import jp.jyn.mecon.Mecon;
import jp.jyn.mecon.config.migration.MainMigration;
import jp.jyn.mecon.config.migration.MessageMigration;
...
public class ConfigLoader {
    ...
    public ConfigLoader() {
        Plugin plugin = Mecon.getInstance();
